 ...
 * Nav icons.
 *
 * These are the Lucide outlines (ISC licensed), inlined rather than pulled in
 * as a dependency: ten shapes do not justify adding a package to an app that
 * is already in production, and inlining keeps them identical to the ones the
